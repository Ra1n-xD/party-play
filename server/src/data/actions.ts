...
export const actionCards: ActionCard[] = [
  ...
  },
  {
    id: 'took_with',
    title: 'Взял с собой',
    description: 'Разыграй карту, только если ты изгнан. Забери любую открытую карту бункера — теперь она у изгнанных',
  ...
  },
  {
    ...
    description: 'Храните карту в тайне. Если изгнан игрок слева, в следующий раз ты обязан голосовать против себя',
    targetRequired: false,
  ...
  },
  {
    ...
    description: 'Храните карту в тайне. Если изгнан игрок справа, в следующий раз ты обязан голосовать против себя',
    targetRequired: false,
  ...
  },
  {
    ...
    description: 'Храните карту в тайне. Если изгнан самый младший (из тех, у кого открыт возраст), в следующий раз ты обязан голосовать против себя',
    targetRequired: false,
  ...
  },
  {
    ...
    description: 'Храните карту в тайне. Если изгнан игрок, первым открывший здоровье, в следующий раз ты обязан голосовать против себя',
    targetRequired: false,
  ...
  },
  {
    ...
    description: 'Храните карту в тайне. Если изгнан самый старший (из тех, у кого открыт возраст), в следующий раз ты обязан голосовать против себя',
    targetRequired: false,
  ...
  },
  {
    id: 'kompromat',
    title: 'Компромат',
    description: 'Голоса против выбранного игрока удваиваются в этом раунде, но сам ты не голосуешь',
    targetRequired: true,
  ...
  },
  {
    id: 'steal_baggage',
    title: 'Мне нужнее',
    description: 'Забери себе карту багажа у любого игрока. Пострадавший берёт из колоды ещё 1 карту особых условий',
    targetRequired: true,
  ...
  },
  {
    id: 'silence',
    title: 'Молчание',
    description: 'Больше никто не говорит в этом раунде до голосования. Можно использовать жесты и пантомиму',
    targetRequired: false,
  ...
  },
  {
    id: 'direct_question',
    title: 'Прямой вопрос',
    description: 'Выбери тип карт — до конца раунда в свой ход все должны открывать карту этого типа, если она ещё не открыта',
    targetRequired: false,
  ...
  },
  {
    id: 'secret_threat',
    title: 'Тайная угроза',
    description: 'Разыграй карту, только если ты изгнан. Банда мародёров узнала о бункере — в финале эта карта дополнительная угроза для тех, кто в бункере',
    targetRequired: false,
